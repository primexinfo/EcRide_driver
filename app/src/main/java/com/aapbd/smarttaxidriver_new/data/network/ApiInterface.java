package com.aapbd.smarttaxidriver_new.data.network;
...
public interface ApiInterface {
    ...
    @GET("api/provider/show/providers")
    ...
    @FormUrlEncoded
    @POST("/api/provider/add/money/ssl")
    Observable<WalletMoneyAddedResponse> addSSLMoney(@FieldMap HashMap<String, Object> obj);
...
//    Observable<Object> sendFcm(@Body JsonObject jsonObject);
    ...
    @GET("api/provider/verify-phone")
    Call<PhoneisAvaiable> isAvaiable(@Query("mobile") String number);
