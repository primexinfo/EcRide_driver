...
public class TripResponse {
    ...
    @SerializedName("isCardMandatory")
    @Expose
    ...
    public String getIsCardMandatory() {
        return isCardMandatory;
    }

    public void setIsCardMandatory(String isCardMandatory) {
        this.isCardMandatory = isCardMandatory;
    }
}
