package com.aapbd.smarttaxidriver_new.ui.countrypicker;
...
public class Country {
    ...
    public static List<Country> getAllCountries() {
        if (allCountriesList == null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                allCountriesList.sort(new NameComparator());
            }
        }
    ...
    public static List<String> getAllCountryNames() {
        ...
        {
            temp.add(country.getName() +" ("+country.getDialCode()+")");
        }

        Log.e("Country name size", temp.size()+"");
        return temp;
    }
    ...
    public static int getCountryImageByDialCode(String dialCode) {
        ...
        for(Country country:allCountriesList)
        {
            if(country.getDialCode().equalsIgnoreCase(dialCode))
    ...
    public static String getCountryCodeByDialCode(String dialCode) {
    ...
    public static int getCountryPositionByCountryCode(String dialCode) {
